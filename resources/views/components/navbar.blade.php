            ...
            <div class="d-flex flex-wrap align-items-center gap-3">
                ...
                <div class="dropdown">
                    <button class="d-flex justify-content-center align-items-center rounded-circle" type="button" data-bs-toggle="dropdown">
                        <img src="{{ auth()->user()->img_picture ? asset('storage/'.auth()->user()->img_picture) : asset('assets/images/user.png') }}" alt="image" class="w-40-px h-40-px object-fit-cover rounded-circle">                    </button>
