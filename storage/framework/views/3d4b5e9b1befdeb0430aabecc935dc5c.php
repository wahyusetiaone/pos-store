...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('name')); ?>" placeholder="Masukkan nama produk">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('sku')); ?>" placeholder="Masukkan kode SKU">
                                    <?php $__errorArgs = ['sku'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('price')); ?>" placeholder="Masukkan harga">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('stock')); ?>" placeholder="Masukkan jumlah stok">
...
unset($__errorArgs, $__bag); ?>">
                                        <option value="1" <?php echo e(old('status') == 'active' ? 'selected' : ''); ?>>Aktif</option>
                                        <option value="0" <?php echo e(old('status') == 'inactive' ? 'selected' : ''); ?>>Tidak Aktif</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>" rows="2" placeholder="Deskripsi produk"><?php echo e(old('description')); ?></textarea>
