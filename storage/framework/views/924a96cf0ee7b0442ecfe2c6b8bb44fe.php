                            ...
                            <div class="mt-32">
                                <div class="d-flex align-items-center justify-content-between gap-3 mb-32">
                                    <div class="d-flex align-items-center gap-2">
                                        <img src="<?php echo e(asset('assets/images/payment/payment1.png')); ?>" alt="" class="w-40-px h-40-px radius-8 flex-shrink-0">
                                ...
                                <div class="d-flex align-items-center justify-content-between gap-3 mb-32">
                                    <div class="d-flex align-items-center gap-2">
                                        <img src="<?php echo e(asset('assets/images/payment/payment2.png')); ?>" alt="" class="w-40-px h-40-px radius-8 flex-shrink-0">
                                        <div class="flex-grow-1">
                                ...
                                <div class="d-flex align-items-center justify-content-between gap-3 mb-32">
                                    <div class="d-flex align-items-center gap-2">
                                        <img src="<?php echo e(asset('assets/images/payment/payment3.png')); ?>" alt="" class="w-40-px h-40-px radius-8 flex-shrink-0">
                                        <div class="flex-grow-1">
                                ...
                                <div class="d-flex align-items-center justify-content-between gap-3 mb-32">
                                    <div class="d-flex align-items-center gap-2">
                                        <img src="<?php echo e(asset('assets/images/payment/payment4.png')); ?>" alt="" class="w-40-px h-40-px radius-8 flex-shrink-0">
                                        <div class="flex-grow-1">
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-32">
                                ...
                                <div class="d-flex align-items-center justify-content-between gap-3 mb-32">
                                    <div class="d-flex align-items-center gap-2">
                                        <img src="<?php echo e(asset('assets/images/users/user6.png')); ?>" alt="" class="w-40-px h-40-px radius-8 flex-shrink-0">
                                        <div class="flex-grow-1">
                                ...
                                <div class="d-flex align-items-center justify-content-between gap-3 mb-32">
                                    <div class="d-flex align-items-center gap-2">
                                        <img src="<?php echo e(asset('assets/images/users/user1.png')); ?>" alt="" class="w-40-px h-40-px radius-8 flex-shrink-0">
                                        <div class="flex-grow-1">
                                ...
                                <div class="d-flex align-items-center justify-content-between gap-3 mb-32">
                                    <div class="d-flex align-items-center gap-2">
                                        <img src="<?php echo e(asset('assets/images/users/user2.png')); ?>" alt="" class="w-40-px h-40-px radius-8 flex-shrink-0">
                                        <div class="flex-grow-1">
                                ...
                                <div class="d-flex align-items-center justify-content-between gap-3 mb-32">
                                    <div class="d-flex align-items-center gap-2">
                                        <img src="<?php echo e(asset('assets/images/users/user3.png')); ?>" alt="" class="w-40-px h-40-px radius-8 flex-shrink-0">
                                        <div class="flex-grow-1">
                                ...
                                <div class="d-flex align-items-center justify-content-between gap-3 mb-32">
                                    <div class="d-flex align-items-center gap-2">
                                        <img src="<?php echo e(asset('assets/images/users/user4.png')); ?>" alt="" class="w-40-px h-40-px radius-8 flex-shrink-0">
                                        <div class="flex-grow-1">
...
<?php echo $__env->make('layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Laravel\wowdash - 2\resources\views/dashboard/index3.blade.php ENDPATH**/ ?>