                ...
                <form method="POST" action="<?php echo e(route('login')); ?>">
                    ...
                    <div class="icon-field mb-16">
                        ...
                        <input type="email" name="email" class="form-control h-56-px bg-neutral-50 radius-12"
                            placeholder="Email" value="<?php echo e(old('email')); ?>" required autofocus autocomplete="username">
...
<?php endif; ?>
                    ...
                    <div class="">
                        <div class="d-flex justify-content-between gap-2">
                            ...
                            <?php if(Route::has('password.request')): ?>
                                <a href="<?php echo e(route('password.request')); ?>" class="text-primary-600 fw-medium">
                                    Forgot Password?
                                </a>
                            <?php endif; ?>
                        </div>
                    ...
                    <div class="mt-32 text-center text-sm">
                        <p class="mb-0">Don't have an account? <a href="<?php echo e(route('register')); ?>" class="text-primary-600 fw-semibold">Sign Up</a></p>
                    </div>
                </form>
            </div>
        </div>
...
<?php /**PATH D:\Project\Experiment\pos_app\resources\views/auth/login.blade.php ENDPATH**/ ?>