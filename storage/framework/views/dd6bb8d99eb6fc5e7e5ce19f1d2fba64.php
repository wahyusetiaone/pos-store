                        ...
                        <div class="card-body p-24">
                            ...
                            <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 bg-neutral-200 px-8 py-8 radius-4 mb-16">
                                <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
                                    <img src="<?php echo e(asset('assets/images/currency/crypto-img1.png')); ?>" alt="" class="w-36-px h-36-px rounded-circle flex-shrink-0">
                                    <div class="flex-grow-1">
                            ...
                            <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 bg-neutral-200 px-8 py-8 radius-4 mb-16">
                                <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
                                    <img src="<?php echo e(asset('assets/images/currency/crypto-img2.png')); ?>" alt="" class="w-36-px h-36-px rounded-circle flex-shrink-0">
                                    <div class="flex-grow-1">
                            ...
                            <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 bg-neutral-200 px-8 py-8 radius-4 mb-16">
                                <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
                                    <img src="<?php echo e(asset('assets/images/currency/crypto-img3.png')); ?>" alt="" class="w-36-px h-36-px rounded-circle flex-shrink-0">
                                    <div class="flex-grow-1">
                            ...
                            <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 bg-neutral-200 px-8 py-8 radius-4 mb-16">
                                <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
                                    <img src="<?php echo e(asset('assets/images/currency/crypto-img4.png')); ?>" alt="" class="w-36-px h-36-px rounded-circle flex-shrink-0">
                                    <div class="flex-grow-1">
                            ...
                            <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 bg-neutral-200 px-8 py-8 radius-4 mb-16">
                                <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
                                    <img src="<?php echo e(asset('assets/images/currency/crypto-img5.png')); ?>" alt="" class="w-36-px h-36-px rounded-circle flex-shrink-0">
                                    <div class="flex-grow-1">
                    ...
                    <div class="card h-100 radius-8 border-0">
                        <div class="card-body">
                            <div class="d-flex align-items-center flex-wrap gap-2 justify-content-between mb-20">
                                ...
                                <a href="<?php echo e(route ('wallet')); ?>" class="btn btn-outline-primary d-inline-flex align-items-center gap-2 text-sm btn-sm px-8 py-6">
                            ...
                            <div>
                                <div class="card-slider">
                                    <div class="p-20 h-240-px radius-8 overflow-hidden position-relative z-1">
                                        <img src="<?php echo e(asset('assets/images/card/card-bg.png')); ?>" alt="" class="position-absolute start-0 top-0 w-100 h-100 object-fit-cover z-n1">

                                        <div class="d-flex flex-column justify-content-between h-100">
                                            <div class="d-flex align-items-center justify-content-between flex-wrap">
                                                <h6 class="text-white mb-0">Master Card</h6>
                                                <img src="<?php echo e(asset('assets/images/card/card-logo.png')); ?>" alt="">
                                            </div>
...
<?php echo $__env->make('layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel\wowdash\resources\views/dashboard/index4.blade.php ENDPATH**/ ?>