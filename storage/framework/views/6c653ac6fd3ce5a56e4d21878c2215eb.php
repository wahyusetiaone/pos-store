        ...
        <div class="card h-100 p-0">
            <div class="card-body p-0">
                ...
                <ul class="ai-chat-list scroll-sm pe-24 ps-24 pb-24">
                    ...
                    <li class="mb-16">
                        <a href="<?php echo e(route('textGenerator')); ?>" class="text-line-1 text-secondary-light text-hover-primary-600">Please create a 5 Column table with HTML Css and js </a>
                    </li>
                    <li class="mb-16">
        ...
        <div class="chat-main card overflow-hidden">
            <div class="chat-sidebar-single gap-8 justify-content-between cursor-default flex-nowrap">
                <div class="d-flex align-items-center gap-16">
                    <a href="<?php echo e(route('textGenerator')); ?>" class="text-primary-light text-2xl line-height-1"><i class="ri-arrow-left-line"></i></a>
...
<?php echo $__env->make('layout.layout2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel\wowdash\resources\views/aiapplication/codeGenerator.blade.php ENDPATH**/ ?>