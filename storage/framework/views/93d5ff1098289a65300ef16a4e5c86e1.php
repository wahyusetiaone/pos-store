        ...
        <div class="col-auto">
            <div class="d-flex flex-wrap align-items-center gap-3">
                ...
                <?php if(!auth()->user()->hasGlobalAccess()): ?>
                    <a href="<?php echo e(route('store.select')); ?>" class="w-40-px h-40-px bg-neutral-100 rounded-circle d-flex justify-content-center align-items-center" title="Switch Toko">
                    ...
                    <div class="dropdown-menu to-top dropdown-menu-sm">
                        <div class="py-12 px-16 radius-8 bg-primary-50 mb-16 d-flex align-items-center justify-content-between gap-2">
                            <div>
                                ...
                                <span class="text-secondary-light fw-medium text-sm"><?php echo e(auth()->user()->role); ?></span>
                            </div>
                        ...
                        <ul class="to-top-list">
                            <li>
                                <a class="dropdown-item text-black px-0 py-8 hover-bg-transparent hover-text-primary d-flex align-items-center gap-3" href="<?php echo e(route('profile.edit')); ?>">
...
<?php /**PATH D:\Project\Experiment\pos_app\resources\views/components/navbar.blade.php ENDPATH**/ ?>