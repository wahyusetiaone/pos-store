                            ...
                            <div>
                                ...
                                <div class="d-flex align-items-center justify-content-between gap-3 mb-3 pb-2">
                                    <div class="d-flex align-items-center w-100">
                                        <img src="<?php echo e(asset('assets/images/flags/flag1.png')); ?>" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                                ...
                                <div class="d-flex align-items-center justify-content-between gap-3 mb-3 pb-2">
                                    <div class="d-flex align-items-center w-100">
                                        <img src="<?php echo e(asset('assets/images/flags/flag2.png')); ?>" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                                        <div class="flex-grow-1">
                                ...
                                <div class="d-flex align-items-center justify-content-between gap-3 mb-3 pb-2">
                                    <div class="d-flex align-items-center w-100">
                                        <img src="<?php echo e(asset('assets/images/flags/flag3.png')); ?>" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                                        <div class="flex-grow-1">
                                ...
                                <div class="d-flex align-items-center justify-content-between gap-3">
                                    <div class="d-flex align-items-center w-100">
                                        <img src="<?php echo e(asset('assets/images/flags/flag4.png')); ?>" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                                        <div class="flex-grow-1">
                                ...
                                <table class="table bordered-table sm-table mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="<?php echo e(asset('assets/images/asset/asset-img1.png')); ?>" alt="" class="flex-shrink-0 me-12 w-40-px h-40-px radius-8 me-12">
                                                    <div class="flex-grow-1">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="<?php echo e(asset('assets/images/asset/asset-img2.png')); ?>" alt="" class="flex-shrink-0 me-12 w-40-px h-40-px radius-8 me-12">
                                                    <div class="flex-grow-1">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="<?php echo e(asset('assets/images/asset/asset-img3.png')); ?>" alt="" class="flex-shrink-0 me-12 w-40-px h-40-px radius-8 me-12">
                                                    <div class="flex-grow-1">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="<?php echo e(asset('assets/images/asset/asset-img4.png')); ?>" alt="" class="flex-shrink-0 me-12 w-40-px h-40-px radius-8 me-12">
                                                    <div class="flex-grow-1">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <img src="<?php echo e(asset('assets/images/asset/asset-img5.png')); ?>" alt="" class="flex-shrink-0 me-12 w-40-px h-40-px radius-8 me-12">
                                                    <div class="flex-grow-1">
                    ...
                    <div class="card h-100">
                        <div class="card-body p-24">
                            ...
                            <div class="d-flex align-items-start gap-2 mb-20">
                                <img src="<?php echo e(asset('assets/images/notice/board-img1.png')); ?>" alt="" class="flex-shrink-0 w-40-px h-40-px me-12 radius-8 me-12">
                                <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-start gap-2 mb-20">
                                <img src="<?php echo e(asset('assets/images/notice/board-img2.png')); ?>" alt="" class="flex-shrink-0 w-40-px h-40-px me-12 radius-8 me-12">
                                <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-start gap-2">
                                <img src="<?php echo e(asset('assets/images/notice/board-img3.png')); ?>" alt="" class="flex-shrink-0 w-40-px h-40-px me-12 radius-8 me-12">
                                <div class="flex-grow-1">
...
<?php echo $__env->make('layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Laravel\wowdash - 2\resources\views/dashboard/index5.blade.php ENDPATH**/ ?>