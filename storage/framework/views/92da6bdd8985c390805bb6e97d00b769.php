...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('sale_date')); ?>">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('customer_id')); ?>" placeholder="ID pelanggan">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('total')); ?>" placeholder="Masukkan total penjualan">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('discount')); ?>" placeholder="Masukkan diskon">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="icon-field">
                                    ...
                                    <input type="number" name="paid" class="form-control <?php $__errorArgs = ['paid'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('paid')); ?>" placeholder="Jumlah dibayar">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('payment_method')); ?>" placeholder="Tunai/Transfer/Dll">
...
unset($__errorArgs, $__bag); ?>" rows="2" placeholder="Catatan penjualan"><?php echo e(old('note')); ?></textarea>
