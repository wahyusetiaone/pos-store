                                    ...
                                    <div class="d-flex flex-column gap-24">
                                        <div class="d-flex align-items-center justify-content-between gap-3">
                                            <div class="d-flex align-items-center">
                                                <img src="<?php echo e(asset('assets/images/home-eight/doctor-img1.png')); ?>" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between gap-3">
                                            <div class="d-flex align-items-center">
                                                <img src="<?php echo e(asset('assets/images/home-eight/doctor-img2.png')); ?>" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                                                <div class="flex-grow-1">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between gap-3">
                                            <div class="d-flex align-items-center">
                                                <img src="<?php echo e(asset('assets/images/home-eight/doctor-img3.png')); ?>" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                                                <div class="flex-grow-1">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between gap-3">
                                            <div class="d-flex align-items-center">
                                                <img src="<?php echo e(asset('assets/images/home-eight/doctor-img4.png')); ?>" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                                                <div class="flex-grow-1">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between gap-3">
                                            <div class="d-flex align-items-center">
                                                <img src="<?php echo e(asset('assets/images/home-eight/doctor-img6.png')); ?>" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                                                <div class="flex-grow-1">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between gap-3">
                                            <div class="d-flex align-items-center">
                                                <img src="<?php echo e(asset('assets/images/home-eight/doctor-img5.png')); ?>" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                                                <div class="flex-grow-1">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between gap-3 mb-24">
                                        <div class="d-flex align-items-center gap-12">
                                            <div class="w-40-px h-40-px rounded-circle flex-shrink-0 bg-info-50 d-flex justify-content-center align-items-center">
                                                <img src="<?php echo e(asset('assets/images/home-eight/treatment-icon1.png')); ?>" alt="" class="">
                                            </div>
                                            <div class="flex-grow-1">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between gap-3 mb-24">
                                        <div class="d-flex align-items-center gap-12">
                                            <div class="w-40-px h-40-px rounded-circle flex-shrink-0 bg-success-50 d-flex justify-content-center align-items-center">
                                                <img src="<?php echo e(asset('assets/images/home-eight/treatment-icon2.png')); ?>" alt="" class="">
                                            </div>
                                            <div class="flex-grow-1">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between gap-3 mb-24">
                                        <div class="d-flex align-items-center gap-12">
                                            <div class="w-40-px h-40-px rounded-circle flex-shrink-0 bg-lilac-50 d-flex justify-content-center align-items-center">
                                                <img src="<?php echo e(asset('assets/images/home-eight/treatment-icon3.png')); ?>" alt="" class="">
                                            </div>
                                            <div class="flex-grow-1">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between gap-3 mb-24">
                                        <div class="d-flex align-items-center gap-12">
                                            <div class="w-40-px h-40-px rounded-circle flex-shrink-0 bg-warning-50 d-flex justify-content-center align-items-center">
                                                <img src="<?php echo e(asset('assets/images/home-eight/treatment-icon4.png')); ?>" alt="" class="">
                                            </div>
                                            <div class="flex-grow-1">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between gap-3 mb-24">
                                        <div class="d-flex align-items-center gap-12">
                                            <div class="w-40-px h-40-px rounded-circle flex-shrink-0 bg-danger-50 d-flex justify-content-center align-items-center">
                                                <img src="<?php echo e(asset('assets/images/home-eight/treatment-icon5.png')); ?>" alt="" class="">
                                            </div>
                                            <div class="flex-grow-1">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between gap-3 mb-0">
                                        <div class="d-flex align-items-center gap-12">
                                            <div class="w-40-px h-40-px rounded-circle flex-shrink-0 bg-primary-50 d-flex justify-content-center align-items-center">
                                                <img src="<?php echo e(asset('assets/images/home-eight/treatment-icon6.png')); ?>" alt="" class="">
                                            </div>
                                            <div class="flex-grow-1">
                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-column gap-24">
                                        <div class="d-flex align-items-center justify-content-between gap-3">
                                            <div class="d-flex align-items-center gap-12">
                                                <div class="flex-shrink-0">
                                                    <img src="<?php echo e(asset('assets/images/home-eight/icon-pdf.png')); ?>" alt="" class="">
                                                </div>
                                                <div class="flex-grow-1">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between gap-3">
                                            <div class="d-flex align-items-center gap-12">
                                                <div class="flex-shrink-0">
                                                    <img src="<?php echo e(asset('assets/images/home-eight/icon-text.png')); ?>" alt="" class="">
                                                </div>
                                                <div class="flex-grow-1">
...
<?php echo $__env->make('layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Laravel\wowdash - 2\resources\views/dashboard/index8.blade.php ENDPATH**/ ?>