                    ...
                    <div class="row" id="productsGrid">
                        ...
                        <div class="col-md-3 mb-3">
                            <div class="card h-100 product-card" data-product-id="<?php echo e($product->id); ?>">
                                <img src="<?php echo e($product->images->first() ? asset('storage/' . $product->images->first()->image_path) : asset('images/no-image.jpg')); ?>"
                                     class="card-img-top" alt="<?php echo e($product->name); ?>" style="height: 200px; object-fit: cover;">
                                <div class="card-body">
                                    <h6 class="card-title m-0 p-0"><?php echo e($product->name); ?></h6>
                                    <p class="card-text text-primary m-0 p-0">Rp <?php echo e(number_format($product->price, 0, ',', '.')); ?>,-</p>
                                    <p class="card-text small m-0 p-0">STOK: <?php echo e($product->stock); ?>x</p>
                                </div>
                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="card">
                <div class="card-header bg-success text-white">
                    <h5 class="mb-0 d-flex justify-content-between">
                        <span>Keranjang</span>
                        <span>NO BON: <?php echo e(str_pad(rand(1, 9999), 4, '0', STR_PAD_LEFT)); ?></span>
                    </h5>
                </div>
                <div class="card-body">
...
<?php echo $__env->make('layout.pos', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project\Experiment\pos_app\resources\views/dashboard/pos.blade.php ENDPATH**/ ?>