                    ...
                    <div class="mt-16">
                        <ul>
                            <li class="item-active mb-4">
                                <a href="<?php echo e(route('veiwDetails')); ?>" class="bg-hover-primary-50 px-12 py-8 w-100 radius-8 text-secondary-light">
...
<?php echo $__env->make('layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel\wowdash\resources\views/email.blade.php ENDPATH**/ ?>